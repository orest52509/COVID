...
# фонова музика
mixer.init()
mixer.music.load('мусік.mp3')
mixer.music.play()
fire_sound = mixer.Sound('cells.mp3')
 
# шрифти і написи
font.init()
font1 = font.SysFont("Arial", 80)
win = font1.render('YOU KOLONIZATOR!', True, (255, 255, 255))
lose = font1.render('YOU KOLONIZIROWAN!', True, (180, 0, 0))
font2 = font.SysFont("Arial", 36)


# нам потрібні такі картинки:
img_back = "фон.jpg"  # фон гри
img_hero = "гравець.jpg"  # герой
img_bullet = "пуля.jpg" # куля
img_enemy = "CoV-2.png"  # ворог
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(
        80, win_width - 80), -40, 80, 50, randint(1, 1))
